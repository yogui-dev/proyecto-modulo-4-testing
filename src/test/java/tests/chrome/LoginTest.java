...
/**
 * Clase de prueba para validar la funcionalidad de inicio de sesión en Chrome.
 * Utiliza datos de prueba desde un archivo CSV para ejecutar múltiples escenarios.
 * Implementa listeners para captura de screenshots en caso de fallos.
 */
@Listeners({ScreenshotListener.class})
public class LoginTest extends BaseTest {

    /**
     * Prueba el proceso de inicio de sesión con diferentes combinaciones de datos.
    ...
    /**
     * Proveedor de datos para las pruebas de login.
